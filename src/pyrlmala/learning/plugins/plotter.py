...
class PlotterBase(ABC):
    """
    Base class for plotting the policy of the learning instance.
...
class PolicyPlotter(PlotterBase):
    ...
    Attributes:
        learning_instance (LearningInterface): The learning instance to be trained.
        num_of_mesh (int): The number of mesh points.
    """
...
class ScatterPlotter(PlotterBase):
    ...
    def _scatter_plot(
        ...
        """
        Plot the scatter plot of the sample. Helper function.
    ...
    def plot(self, step: int, axes: Axes, alpha: float = 0.1) -> None:
        ...
        Args:
            step (int): Current training step.
            axes (Axes): The axes to plot on.
            alpha (float, optional): The transparency of the plot. Defaults to 1.0.
        """
        pipe(
...
class TrainingVisualizer(PluginBase):
    """
    Callback for plotting the policy of the learning instance in 2D. Only works for 2D environments.

    Attributes:
        learning_instance (LearningInterface): The learning instance to be trained.
        plot_frequency (int): The frequency of plotting the policy.
        num_of_mesh (int): The number of mesh points.
    """
    ...
    def _policy_plot(self, step: int, axes: Axes) -> None:
        """
    ...
    def _scatter_plot(self, step: int, axes: Axes) -> None:
        """
        Plot the sample scatter of the learning instance in 2D.
